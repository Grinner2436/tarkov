...
//    //所有物品的树节点
//    private static Map<String, Node<T>> nodesMap = new HashMap<>();
//
//    private static Node<T> root = new Node<T>("54009119af1c881c07000029", "总类", "Node");
//    static {
//        //先有根节点
...
//    }
//
//    public static Node<T> addNode(Item nodeItem, String type) {
//        String id = nodeItem.getId();
//        if (nodesMap.containsKey(id)) {
//            return null;
//        }
//
//        Node<T> currentNode = new Node<T>(id, nameMap.get(id), type);
